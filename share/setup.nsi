...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER Solarcoin
!define MUI_FINISHPAGE_RUN $INSTDIR\solarcoin-qt.exe
...
Section -Main SEC0000
    ...
    Delete /REBOOTOK $INSTDIR\solarcoin.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Solarcoin.lnk" $INSTDIR\solarcoin-qt.exe
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Uninstall Solarcoin.lnk" $INSTDIR\uninstall.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Uninstall Solarcoin.lnk"
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Solarcoin.lnk"
    Delete /REBOOTOK "$SMSTARTUP\Solarcoin.lnk"
