...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: solarcoin.conf)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 33355 or testnet: 133355)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 33354 or testnet: 133354)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Solarcoin Wiki for SSL setup instructions)") + "\n" +
